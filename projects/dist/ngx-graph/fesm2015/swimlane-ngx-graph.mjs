...
class D3ForceDirectedLayout {
  ...
  d3GraphToOutputGraph(d3Graph) {
    ...
    this.outputGraph.edges = this.d3Graph.edges.map(edge =>
      Object.assign(Object.assign({}, edge), {
...
class GraphComponent {
  ...
  createGraph() {
    ...
    const initializeNode = n => {
      ...
      if (
        this.updateCount == 0 &&
        ((_b = (_a = n.data) === null || _a === void 0 ? void 0 : _a.data) === null || _b === void 0
          ? void 0
          : _b.position)
      ) {
        const p =
          (_d = (_c = n.data) === null || _c === void 0 ? void 0 : _c.data) === null || _d === void 0
            ? void 0
            : _d.position;
  ...
  draw() {
    ...
    if (
      ...
      ((_a = this.graph.compoundNodes) === null || _a === void 0 ? void 0 : _a.length) === 0
    ) {
      return;
    }
  ...
  zoomToFit(zoomOptions) {
    ...
    if (
      (zoomOptions === null || zoomOptions === void 0 ? void 0 : zoomOptions.force) === true ||
  ...
  updateMidpointOnEdge(edge, points) {
    ...
    if (points.length % 2 === 1) {
      ...
      if (
        (_c =
          (_b = (_a = this.layout) === null || _a === void 0 ? void 0 : _a.settings) === null || _b === void 0
            ? void 0
  ...
  hasNodeDims() {
    var _a;
    return (_a = this.graph.nodes) === null || _a === void 0
      ? void 0
      : _a.every(node => node.dimension.width > 0 && node.dimension.height > 0);
  }
  /**
  ...
  hasCompoundNodeDims() {
    var _a;
    return (_a = this.graph.compoundNodes) === null || _a === void 0
      ? void 0
      : _a.every(node => node.dimension.width > 0 && node.dimension.height > 0);
  }
  /**
...
GraphComponent.ɵfac = i0.ɵɵngDeclareFactory({
  ...
  ngImport: i0,
  type: GraphComponent,
  deps: [{ token: i0.ElementRef }, { token: i0.NgZone }, { token: i0.ChangeDetectorRef }, { token: LayoutService }],
...
GraphComponent.ɵcmp = i0.ɵɵngDeclareComponent({
  ...
  directives: [
    { type: MouseWheelDirective, selector: '[mouseWheel]', outputs: ['mouseWheelUp', 'mouseWheelDown'] },
...
i0.ɵɵngDeclareClassMetadata({
  ...
  ctorParameters: function () {
    return [{ type: i0.ElementRef }, { type: i0.NgZone }, { type: i0.ChangeDetectorRef }, { type: LayoutService }];
  },
  propDecorators: {
    nodes: [
      {
